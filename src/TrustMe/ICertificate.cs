...
namespace TrustMe
{
	...
	public interface ICertificate
	{
		...
		ReadOnlyCollection<byte> Encrypt(ReadOnlyCollection<byte> plainText);
	...
	public interface ICertificate<TEmbeddedData> where TEmbeddedData : IHashable
	{
		/// <summary>
		/// Gets the embedded data.
		/// </summary>
		TEmbeddedData EmbeddedData { get; }
	}
}
